...
export class AlterDiseaseQuestionnaireTable1635027474246
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      'ALTER TABLE "questionnaires" ADD "disease_id" integer',
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      'ALTER TABLE "questionnaires" DROP CONSTRAINT "FK_4ab5c99a66d8528489511a78030"',
    );
    await queryRunner.query(
      'ALTER TABLE "questionnaires" DROP COLUMN "disease_id"',
    );
  }
}
