...
export class AlterDiseaseQuestionnaireTable1635027474246 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "diseases" ADD CONSTRAINT "FK_5c9f88269cd3b40030740f5b6a5" 
        FOREIGN KEY ("questionnaires_id") REFERENCES "questionnaires"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
